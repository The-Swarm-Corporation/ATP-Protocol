## Quick Tutorial: Anthropic + ATP Protocol
...
Create a `.env` file in this `anthropic/` folder:
...
### 4. Run the Anthropic + ATP server

From this `anthropic/` folder:
...
In a **separate terminal**, still in this `anthropic/` folder:
...
- Trigger an Anthropic completion behind the scenes
...
- The model output from Anthropic
...
If you can see all three, your **Anthropic + ATP** tutorial is working end-to-end.
