## Quick Tutorial: AutoGen + ATP Protocol
...
Create a `.env` file in this `autogen/` folder:
...
### 4. Run the AutoGen + ATP server

From this `autogen/` folder:
...
In a **separate terminal**, still in this `autogen/` folder:
...
- Trigger an AutoGen multi-agent conversation behind the scenes
...
If you can see all three, your **AutoGen + ATP** tutorial is working end-to-end.
