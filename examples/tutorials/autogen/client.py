"""
Client example for AutoGen + ATP Protocol API
...
def chat_with_agent():
    """Example 1: Chat with AutoGen agent"""
    print("\n=== Example 1: Chat with AutoGen Agent ===\n")
...
def execute_task():
    """Example 2: Execute AutoGen agent task"""
    print("\n=== Example 2: Execute AutoGen Agent Task ===\n")
    
    response = httpx.post(
        f"{API_BASE_URL}/v1/agent/task",
        headers=headers,
        json={
...
if __name__ == "__main__":
    print("AutoGen + ATP Protocol Client Example")
    print("=" * 50)
