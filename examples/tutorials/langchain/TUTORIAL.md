## Quick Tutorial: LangChain + ATP Protocol
...
Create a `.env` file in this `langchain/` folder:
...
### 4. Run the LangChain + ATP server

From this `langchain/` folder:
...
In a **separate terminal**, still in this `langchain/` folder:
...
- Trigger a LangChain agent run behind the scenes
...
- The model output from the LangChain agent
...
If you can see all three, your **LangChain + ATP** tutorial is working end-to-end.
